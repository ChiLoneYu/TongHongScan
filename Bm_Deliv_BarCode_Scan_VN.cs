...
{
    public class Bm_Deliv_BarCode_Scan_VN : BaseModel.Erp_Common.bmo_base
    {
         ...
         private DateTime _VN_scan_date = DateTime.Today;

         public DateTime VN_scan_date
         {
             get { return _VN_scan_date; }
             set { _VN_scan_date = value; }

         }
         public Bm_Deliv_BarCode_Scan_VN()
		{
		}
